<template>
  <div class="col-span-3 relative">
    ...
    <div
      class="fixed top-0 left-0 bottom-0 transition duration-300 -translate-x-full lg:translate-x-0 lg:translate-y-0 opacity-0 lg:opacity-100 invisible lg:visible lg:relative lg:mt-6 bg-white shadow rounded max-w-[300px] w-full lg:w-full p-4 divide-y divide-gray-200 space-y-4 text-gray-600 z-10"
      :class="{
