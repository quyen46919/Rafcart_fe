  ...
  <div class="col-span-3">
    ...
    <div class="px-4 py-3 w-[280px] h-[66px] shadow flex items-center gap-4">
      ...
      <div>
        ...
        <h4 class="text-gray-800 text-lg capitalize font-medium">{{ user?.username }}</h4>
      </div>
    </div>
    <!-- account profile end -->
    ...
    <div class="mt-6 bg-white shadow rounded w-[280px] p-4 divide-y divide-gray-200 space-y-4 text-gray-600">
      ...
      <div class="space-y-1 pl-8">
        <a href="account.html" class="relative  text-gray-800  font-medium capitalize hover:text-primary transition block">
          Manage account
      ...
      <div class="pl-8 pt-4">
        <a
          href="wishlist.html"
          class="relative medium text-gray-800 capitalize font-medium hover:text-primary transition block "
        >
          my wishlist
          <span class="absolute -left-8 top-0 text-base">
