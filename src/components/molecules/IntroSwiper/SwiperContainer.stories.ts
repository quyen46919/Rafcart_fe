...
export const Default: Story = {
  ...
  args: {
    slides: [
      ...
      {
        banner: '/src/assets/images/banner-bg.jpg',
        title: '2 Long Text Another Collection For Another Collection For Home',
        text: 'Another example text for the first part. More text for the second part.Another example text for the first part. More text for the second part. Another example text for the first part. More text for the second part.'
      },
      {
        banner: '/src/assets/images/banner-bg.jpg',
